...
function mtp() {
        var soundtrackinfo = document.getElementById("multi-info2").innerHTML;
        var automatic = soundtrackinfo.split(" ");
        var jump = automatic.length - 1;
        var soundtracktitles = document.getElementById("multi-names2").innerHTML;
        ...
        document.getElementById("mtplayer2").innerHTML = '<audio id="audio" preload="auto"><source src="' + automatic[2] + '" type="audio/mpeg"></audio><div id="controls1"><div id="play"></div><div id="pause"><div id="pause1"></div><div id="pause2"></div><div id="isolate2"></div></div></div><div id="controls2"><div id="skip"><div id="skip1"></div><div id="skip2"></div><div id="isolate3"></div></div></div><div id="tracktitle"></div><div id="isolate"></div>';
        document.getElementById("mtplayer2").style.display = "block";
        document.getElementById("mtplayer2").style.width = "25px";
        document.getElementById("mtplayer2").style.padding = "0px 15px";
        ...
        tracktitle.style.marginTop = "-1px";
        tracktitle.style.marginLeft = "32px";
        ...
        play.style.borderLeft = "7px solid " + automatic[0];
        ...
        skip1.style.borderTop = "5px solid transparent";
        skip1.style.borderLeft = "5px solid " + automatic[0];
        skip1.style.borderBottom = "5px solid transparent";
        skip2.style.display = "block";
        skip2.style.float = "left";
        skip2.style.width = "0px";
        skip2.style.height = "0px";
        skip2.style.borderTop = "5px solid transparent";
        skip2.style.borderLeft = "5px solid " + automatic[0];
        skip2.style.borderBottom = "5px solid transparent";
        if (automatic[1] == "on") {
                audio.play();
