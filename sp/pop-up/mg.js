...
document.onclick = function(e) {
        ...
        if (e.target.id === "stylecode") {
                stylecode.style.backgroundColor = "#000";
                stylecode.style.color = "#32CD32";

                bodycode.style.backgroundColor = "#FAFAFA";
                bodycode.style.color = "#999";

                SelectText("stylecode");
        } else if (e.target.id === "bodycode") {
                bodycode.style.backgroundColor = "#000";
                bodycode.style.color = "#32CD32";

                stylecode.style.backgroundColor = "#FAFAFA";
                stylecode.style.color = "#999";
